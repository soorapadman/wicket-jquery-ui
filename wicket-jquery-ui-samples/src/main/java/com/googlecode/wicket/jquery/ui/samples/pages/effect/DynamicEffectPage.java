	...
	public DynamicEffectPage()
	{
		...
		form.add(new AjaxButton("button") {
			...
			protected void onSubmit(AjaxRequestTarget target, Form<?> form)
			{
				...
				JQueryEffectBehavior hide = new JQueryEffectBehavior("#tabs", Effect.Explode);
				target.appendJavaScript(hide.toString());

				// re-display the panel using fade(in) //
				JQueryEffectBehavior show = new JQueryEffectBehavior("#tabs", Effect.Fade);
				target.appendJavaScript(show.toString());
			}
		});
	}
}
